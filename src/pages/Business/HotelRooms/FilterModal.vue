<template>
    <div class="rooms__filter__modal" @mousedown="closeModal">
        <div class="rooms__filter__modal__content">
            <nav class="rooms__filter__nav">
                <ul>
                    <li>Filters</li>
                </ul>
            ...
            <form class="rooms__filter__form" v-on:click.prevent="">
                ...
                <button class="rooms__filter__btn" v-on:click="filterRooms" v-on:mouseenter="btnAnimation">
                    Filter now
                    <div class="rooms__btn__container">
                        <div class="rooms__btn--effect">
                            <img src="../../../assets/Button_arrow_two.svg" alt="Filter button icon" />
                            <img src="../../../assets/Button_arrow_two.svg" alt="Filter button icon" />
                        </div>
                    </div>
                </button>
...
export default {
    ...
    mounted() {
        ...
        const modal = document.querySelector('.rooms__filter__modal');
        modal.style.height = document.documentElement.scrollHeight + "px";
    },
    methods: {
        closeModal(evt) {
            if(evt.target.className === 'rooms__filter__modal') {
                this.$emit('modal');
            }
        },
        btnAnimation() {
        ...
        filterRooms() {
            ...
            this.$store.dispatch('filterHotelRooms', args).roomsModule;
        }
    }
}
</script>
